    ...
    <>
      ...
      <Container fluid className="mainListNote">
        <Row>
          ...
          <Col xs={12} lg={8}>
            <div className="cajaMostrarNotas">
              <h2 className="tusNotasH2">Tus notas</h2>
              <div className="contenedorNotasAgregadas">
                <div className="notaListaEstilos">
                  <svg
                  ...
                  <p className="contenidoNotaIngresada">
                    Pedir stock de medias
                  </p>
                  <div className="cajaBotonEditarBorrar">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="22"
                      height="22"

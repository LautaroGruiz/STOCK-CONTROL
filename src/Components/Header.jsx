            ...
            >
              ...
              <section className="bodyNavBar">
                <div className="cajaBotonesDeSecciones">
                  <a href="/inventario" className="linkDeSeccion">
                    <svg
                    ...
                    <p className="tittleSeccionNavBar">
                  ...
                  <a href="" className="linkDeSeccion">
                    ...
                    <p className="tittleSeccionNavBar">Ventas</p>
                  </a>
                  <a href="" className="linkDeSeccion">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                    ...
                    <p className="tittleSeccionNavBar">Compras</p>
                  </a>
                  <a href="" className="linkDeSeccion">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                    ...
                    <p className="tittleSeccionNavBar">Proveedores</p>
                  </a>

                  <a href="/list-note" className="linkDeSeccion">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="16"
                      height="16"
                    ...
                    <p className="tittleSeccionNavBar">Reportes</p>
                  </a>
                </div>
